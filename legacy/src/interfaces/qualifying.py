...
import time
import numpy as np
from legacy.src.ui_components import build_track_from_example_lap, LapTimeLeaderboardComponent, QualifyingSegmentSelectorComponent
from shared.telemetry.f1_data import get_driver_quali_telemetry
from shared.telemetry.f1_data import FPS
